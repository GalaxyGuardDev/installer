...
warningNotification('Galaxyguard', 'Bedwars Loaded', 6)
...
run(function()
	...
	AimAssist = combat.Api.CreateOptionsButton({
		Name = "AimAssist",
...
run(function()
	...
	local noclickfunc
	noclickdelay = combat.Api.CreateOptionsButton({
		Name = "NoClickDelay",
		Function = function(callback)
			if callback then
...
run(function()
	...
	local oldclickhold2
	local roact
	local FastConsume = blatant.Api.CreateOptionsButton({
		Name = "FastConsume",
		Function = function(callback)
			if callback then
...
run(function()
	...
	GrappleExploit = blatant.Api.CreateOptionsButton({
		Name = "GrappleExploit",
		Function = function(callback)
			if callback then
...
run(function()
	...
	InfiniteFly = blatant.Api.CreateOptionsButton({
		Name = "InfiniteFly",
		Function = function(callback)
			if callback then
...
run(function()
	...
	local oldfall
	NoFall = blatant.Api.CreateOptionsButton({
		Name = "NoFall",
		Function = function(callback)
			if callback then
...
run(function()
	...
	NoSlowdown = blatant.Api.CreateOptionsButton({
		Name = "NoSlowdown",
		Function = function(callback)
			if callback then
...
run(function()
	...
	local BowAimbot = blatant.Api.CreateOptionsButton({
...
run(function()
	...
	BedPlates = visual.Api.CreateOptionsButton({
		Name = "BedPlates",
		Function = function(callback)
			if callback then
...
run(function()
	...
	ChestESP = visual.Api.CreateOptionsButton({
		Name = "ChestESP",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	GameFixer = visual.Api.CreateOptionsButton({
		Name = "GameFixer",
		Function = function(callback)
...
run(function()
	...
	GameTheme = visual.Api.CreateOptionsButton({
		Name = "GameTheme",
		Function = function(callback)
			if callback then
...
run(function()
	...
	KillEffect = visual.Api.CreateOptionsButton({
		Name = "KillEffect",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	KitESP = visual.Api.CreateOptionsButton({
		Name = "KitESP",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	local oldc1
	local oldfunc
	local nobob = visual.Api.CreateOptionsButton({
		Name = "NoBob",
		Function = function(callback)
...
run(function()
	...
	visual.Api.CreateOptionsButton({
		Name = "UICleanup",
		Function = function(callback)
...
run(function()
	...
	AntiAFK = utility.Api.CreateOptionsButton({
		Name = "AntiAFK",
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoBalloon = utility.Api.CreateOptionsButton({
		Name = "AutoBalloon",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	AutoHotbar = utility.Api.CreateOptionsButton({
		Name = "AutoHotbar",
		Function = function(callback)
			if callback then
				AutoHotbarSort()
...
run(function()
	...
	AutoForge = utility.Api.CreateOptionsButton({
		Name = "AutoForge",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	AutoReportV2 = utility.Api.CreateOptionsButton({
		Name = "AutoReportV2",
		Function = function(callback)
			if callback then
				task.spawn(function()
			...
			if callback then
				table.insert(AutoToxic.Connections, vapeEvents.BedwarsBedBreak.Event:Connect(function(bedTable)
					if AutoToxicBedDestroyed.Enabled and bedTable.brokenBedTeam.id == lplr:GetAttribute("Team") then
						local custommsg = #AutoToxicPhrases6.ObjectList > 0 and AutoToxicPhrases6.ObjectList[math.random(1, #AutoToxicPhrases6.ObjectList)] or "How dare you break my bed 🅝🅘🅖🅖🅔🅡 >:( <name> | galaxyguard on top"
						if custommsg then
					...
					elseif AutoToxicBedBreak.Enabled and bedTable.player.UserId == lplr.UserId then
						local custommsg = #AutoToxicPhrases7.ObjectList > 0 and AutoToxicPhrases7.ObjectList[math.random(1, #AutoToxicPhrases7.ObjectList)] or "yooooooooo cool bed 🅝🅘🅖🅖🅔🅡 🅚🅨🅢 🅥🅞🅘🅓 🅘🅢 🅢🅚🅘🅓🅓🅔🅓 :) <teamname> | galaxyguard on top"
						if custommsg then
					...
					if deathTable.finalKill then
						...
						if killed == lplr then
							if (not leavesaid) and killer ~= lplr and AutoToxicDeath.Enabled then
								leavesaid = true
								local custommsg = #AutoToxicPhrases3.ObjectList > 0 and AutoToxicPhrases3.ObjectList[math.random(1, #AutoToxicPhrases3.ObjectList)] or "My wave 6 hour key expired midfight, thats why you won <name> | galaxyguard on top"
								if custommsg then
							...
							if killer == lplr and AutoToxicFinalKill.Enabled then
								local custommsg = #AutoToxicPhrases2.ObjectList > 0 and AutoToxicPhrases2.ObjectList[math.random(1, #AutoToxicPhrases2.ObjectList)] or "womp womp cry about it <name> | galaxyguard on top"
								if custommsg == lastsaid then
									custommsg = #AutoToxicPhrases2.ObjectList > 0 and AutoToxicPhrases2.ObjectList[math.random(1, #AutoToxicPhrases2.ObjectList)] or "womp womp cry about it <name> | galaxyguard on top"
								else
									lastsaid = custommsg
								end
								if custommsg then
				...
				table.insert(AutoToxic.Connections, vapeEvents.MatchEndEvent.Event:Connect(function(winstuff)
					...
					if myTeam and myTeam.id == winstuff.winningTeamId or lplr.Neutral then
						...
						if AutoToxicWin.Enabled then
							local custommsg = #AutoToxicPhrases.ObjectList > 0 and AutoToxicPhrases.ObjectList[math.random(1, #AutoToxicPhrases.ObjectList)] or "EZ L 🅝🅘🅖🅖🅔🅡🅢| galaxyguard on top"
							if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
								textChatService.ChatInputBarConfiguration.TargetTextChannel:SendAsync(custommsg)
							else
								replicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(custommsg, 'All')
				...
				table.insert(AutoToxic.Connections, vapeEvents.LagbackEvent.Event:Connect(function(plr)
					if AutoToxicLagback.Enabled then
						...
						local msg = custommsg or "Imagine getting flagged L 🅝🅘🅖🅖🅔🅡"..(plr.DisplayName or plr.Name).." | galaxyguard on top"
						if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
					...
					if AutoToxicRespond.Enabled then
						...
						if plr and plr ~= lplr and not alreadyreported[plr] then
							...
							if reportreason then
								...
								local msg = custommsg or "I don't care about the fact that I'm exploiting, I care about you dying in a block game. L "..(plr.DisplayName or plr.Name).." | galaxyguard on top"
								if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
									textChatService.ChatInputBarConfiguration.TargetTextChannel:SendAsync(msg)
								else
									replicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(msg, 'All')
...
run(function()
	...
	ChestStealer = utility.Api.CreateOptionsButton({
		Name = "ChestStealer",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	MissileTP = utility.Api.CreateOptionsButton({
		Name = "MissileTP",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	PickupRange = utility.Api.CreateOptionsButton({
		Name = "PickupRange",
		Function = function(callback)
			if callback then
				local pickedup = {}
...
run(function()
	...
	RavenTP = utility.Api.CreateOptionsButton({
		Name = "RavenTP",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	AntiVoid = world.Api.CreateOptionsButton({
		Name = "AntiVoid",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	local AutoTool = world.Api.CreateOptionsButton({
		Name = "AutoTool",
		Function = function(callback)
			if callback then
...
run(function()
	...
	BedProtector = world.Api.CreateOptionsButton({
		Name = "BedProtector",
		Function = function(callback)
			if callback then
				task.spawn(function()
...
run(function()
	...
	Nuker = world.Api.CreateOptionsButton({
		Name = "Nuker",
		Function = function(callback)
			if callback then
				for i,v in pairs(store.blocks) do
                ...
                task.spawn(function()
                    repeat 
                        ...
                        local args_swing = {
                            [1] = {
                                ["chargeRatio"] = 1,
                                ["weapon"] = folder and folder:FindFirstChild("guards_spear")
                            }
                        }

                        game:GetService("ReplicatedStorage").rbxts_include.node_modules:FindFirstChild("@rbxts").net.out._NetManaged.SwordSwingMiss:FireServer(unpack(args_swing))
...
run(function()
	...
	insta = exploit.Api.CreateOptionsButton({
		Name = "EmberInstakill",
		Function = function(callback)
			if callback then
				warningNotification("EmberInstakill", "Infernal blade is required for this to work", 1)
				task.spawn(function()
					repeat
						task.wait()
...
print("GALAXYGUARD | 6872274481.lua")

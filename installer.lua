...
local function vapeGithubRequest(scripturl)
	if not isfile('vape/'..scripturl) then
		local suc, res = pcall(function() 
            return game:HttpGet('https://raw.githubusercontent.com/GalaxyGuardDev/installer/main/'..scripturl, true) 
        end)
...
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/GalaxyGuardDev/installer/contents/Profiles')
...
return loadstring(game:HttpGet("https://raw.githubusercontent.com/GalaxyGuardDev/installer/main/Loader.lua", true))()
